...
#[no_mangle]
extern "C" {
    pub fn UndefinedEntryTrampoline();

    pub fn SVCallTrampoline();

    pub fn PrefetchAbortTrampoline();

    pub fn DataAbortTrampoline();

    pub fn RestTrampoline(); 
    pub fn PhantomInterruptTrampoline();
}
